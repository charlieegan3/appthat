...
Channel.delete_all
Channel.create(title: 'Social', tags: %w(feed people subtweets muted blocked fb ig twitter snapchat stories tweets social instagram post tinder messages follow blocks friends tweet facebook insta unfollow posts facetime contacts relationship share friend talking sender unfollows block))
...
Channel.create(title: 'Geo', tags: %w(nearest locate uber local drive walk places area miles directions roads road locations location weather nearby delivers))
